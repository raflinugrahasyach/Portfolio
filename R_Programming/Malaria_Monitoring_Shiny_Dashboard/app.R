...
dashboard_ui <- dashboardPage(
  ...
  dashboardHeader(
    title = tags$div(
      class = "custom-header",
      "analytics interface Informasi dan Analisis Malaria Indonesia"
    ),
    ...
    output[[paste0(var, "_highest")]] <- renderUI({
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$div(
            class = "description", 
            max_prov$Provinsi # Deresearch_project di kanan
          )
        )
      )
    })
    ...
    output[[paste0(var, "_lowest")]] <- renderUI({
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$div(
            class = "description", 
            min_prov$Provinsi # Deresearch_project di kanan
          )
        )
      )
    })
    ...
    output[[paste0(var, "_mean")]] <- renderUI({
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$div(
            class = "description",
            "Rata-rata" # Deresearch_project tambahan di kanan
          )
        )
      )
    })
