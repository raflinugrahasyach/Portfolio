...
# Deresearch_project aplikasi
st.markdown("""
# Selamat Datang di analytics interface Analisis Sentimen Program Stunting
...
# Tambahkan gambar analytics interface di halaman utama
